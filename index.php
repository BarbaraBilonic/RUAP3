...
register.</p>
 ...
 <?php
// DB connection info
// Update the values for $host, $user, $pwd, and $db //using the values you retrieved
//earlier from the Azure Portal. $host = "value of Data Source";
$host = "bbilonic-mysqldbserver.mysql.database.azure.com";
$user = "ruapbilonic@bbilonic-mysqldbserver";
$pwd = "Olipija1998";
$db = "ruapdb";
// Connect to database.
...
mysql -h{bbilonic-mysqldbserver.mysql.database.azure.com] -u[ruapbilonic@bbilonic-mysqldbserver] -p[Olimpija1998] -D[ruapdb]